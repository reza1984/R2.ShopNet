...
/// Verifies the passkey assertion and returns the authenticated user.
/// Token generation is handled by the controller using OpenIddict.
/// </summary>
public class LoginWithPasskeyCommandHandler : ICommandHandler<LoginWithPasskeyCommand, Result<LoginWithPasskeyResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            // Return success with user ID - token generation will be handled by the controller
