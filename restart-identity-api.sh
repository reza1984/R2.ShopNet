...
echo "  POST https://localhost:5001/api/auth/register"
echo "  POST https://localhost:5001/api/auth/login"
echo "  POST https://localhost:5001/api/auth/forgot-password"
echo "  POST https://localhost:5001/api/auth/reset-password"
echo ""
echo "🧪 To test forgot-password:"
echo "curl -k -X POST https://localhost:5001/api/auth/forgot-password \\"
